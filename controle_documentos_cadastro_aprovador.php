...
if(isset($_POST['done'])){   
	...
	if(empty($nome) || empty($email)){
       ...
       $sql = mysql_query("INSERT INTO `controle_documentos_aprovador`(`data_cadastro`,`nome`, `email`,`aprov`) VALUES (now(),'$nome', '$email','X')") or die(mysql_error());
 ...
 <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js'></script><script  src="./script.js"></script>
    <section class="hero is-success is-fullheight">
                ...
                <div class="column is-4 is-offset-4">
                    ...
                    <h1 class="title has-text-grey">CADASTRO DE APROVADORES</h1><center>
					<h2 class="title has-text-grey"><font size=4>[Tecnologia da Informação]</font></h2>                   
					
					<br>
                    <div class="box">
                        <form name="form1" action="controle_documentos_cadastro_aprovador.php" method="POST">
						<?php
if(isset($erro)){
...
?>	
   ...
   @mysql_select_db($db);//selecione o banco de dados    
    ...
    $sqltudo = mysql_query("select  * FROM controle_documentos_aprovador where aprov='X'")  or die(mysql_error());           
