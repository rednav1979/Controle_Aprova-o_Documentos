...
?> 
					...
					<p align=right>
					<a href=https://lotisa-my.sharepoint.com/:v:/g/personal/ti_lotisa_com_br/ESTCZH10IOZNiSAarxSxi7kBxlDns2QN-ELg_kyPh6qC6w?e=YNpmE4&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZyIsInJlZmVycmFsQXBwUGxhdGZvcm0iOiJXZWIiLCJyZWZlcnJhbE1vZGUiOiJ2aWV3In19>AJUDA?</a>
					</center><br><br><br>
					<p align="left">
...
//	if($colaborador_retorno ==''){
//		print 	'<font color=red size=4>';
//		print 'DIGITE UM NOME PARA PROCURAR';
//		print'</font>';	
		
//	}else{
	$sqltudo = mysql_query("select  * FROM controle_documentos  where descricao like UPPER('$colaborador_retorno%') and D_E_L_E_T_E is NULL order by id desc limit 10 ")  or die(mysql_error());           
    $colunas = mysql_num_rows($sqltudo);	   
	   ...
	   print'<td><b>USUARIOAPROVACAO</td>';	   
	   ...
	   /*print '<table border=1>';/*monta a tabela de eventos*/
	       ...
	       print'<tr>';
		   print'<tr>';
	       print '<td>'.$id.'<a href="delete.php?id='.$id.'"><img src=images/bolinha_vermelha.png width=10 height=10"></a>';	   
		   //print '<a href="delete.php?id='.$id.'"><img src=images/bolinha_vermelha.png width=10 height=10 alt="Excluir"></a>';	   
		   print '</td>';	       
	   ...
	   // INCLUI O NUMERO DE HISTORICOS AO LADO DO ICONE DE HISTORICO
		   ...
		   //FIM DA INCLUSAO 
	print '<td><a href="listar_pesquisa_detalhes.php?id='.$id.'"><img src=images/passarinho.png></a>';		   
	   ...
	   if ($url_documento == ""){	
		print ' <td><form method="post" action="file_upload.php?id='.$id.'" enctype="multipart/form-data">
					...
					<input type="submit" value="Enviar" /><font color=red><b>*.PDF</b></font>
		     		</form></td>';	   			   
